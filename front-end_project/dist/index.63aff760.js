...
var _265200X300Jpg = require("./image/265-200x300.jpg");
var _265200X300JpgDefault = parcelHelpers.interopDefault(_265200X300Jpg);
...
const App = ()=>{
  ...
  <div class="container">
    ${(0, _headerDefault.default)()}
      ...
      <h2> ${APP_NAME}</h2>
      <h2> ${API_KEY}</h2>
      <h2>SERVER API: ${"id_client"}</h2>
      <div><img src="${0, _265200X300JpgDefault.default}"></div>
...
},{"../assets/header.css":"bScjN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../assets/header.module.scss":"diptl"}],"bScjN":[function() {},{}],"diptl":[function(require,module,exports) {
...
module.exports = JSON.parse('{"APP_NAME":"F8 Fullstack","API_KEY":"ahihi"}');

},{}],"9ppTi":[function(require,module,exports) {
module.exports = require("fb6a44bc9afd6686").getBundleURL("3gKDs") + "265-200x300.0726be79.jpg" + "?" + Date.now();

},{"fb6a44bc9afd6686":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
